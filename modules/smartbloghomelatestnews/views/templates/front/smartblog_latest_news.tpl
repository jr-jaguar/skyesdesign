  ...
  <div class="block_content">
    <ul class="row">
      {if isset($view_data) && !empty($view_data)}
        ...
        {/foreach}
      {/if}
      <li class="link_btn"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='See more' mod='smartbloghomelatestnews'}</a></li>
    </ul>
  </div>
</section>