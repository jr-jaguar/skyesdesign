...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}><head>
    ...
    <link rel="stylesheet" href="http{if Tools::usingSecureMode()}s{/if}://fonts.googleapis.com/css?family=Playfair+Display:400,700,900%7CRaleway:300,400,400i,500,600,700%7CRoboto:300,400,500,700%7Csubset=cyrillic,cyrillic-ext" type="text/css" media="all" />
    {if isset($css_files)}
    ...
    <div id="page">
      ...
      <div class="columns-container">
        <div id="columns">
          ...
          <div class="container{if $page_name =='cms'}-fluid{/if}">
            <div class="row">
